      ...
      <div className="relative z-10">
        ...
        <div className="max-w-2xl mx-auto mb-10 p-6 border-x-2 border-gold-500/50 bg-charcoal-900/60 backdrop-blur-sm shadow-xl">
          ...
          <p className="text-[11px] text-ivory-300 uppercase tracking-widest font-sans">
            O Lord Ganesha, of curved trunk and immense form, radiant as a million suns, remove all
            obstacles from our paths forever.
          </p>
        </div>

        <h2 className="text-xs sm:text-sm uppercase tracking-[0.3em] text-gold-400 mb-3">
          <span className="font-extrabold">{associationName}</span> &bull;{' '}
        ...
        <div className="space-y-6 text-ivory-200/90 text-sm sm:text-base leading-relaxed font-sans max-w-3xl mx-auto">
          <p className="font-editorial italic text-xl sm:text-2xl text-ivory-100 leading-relaxed">
            &ldquo;In our beloved village of {villageName}, {associationName}&rsquo;s Vinayaka
            Chavithi is not merely a festival - it is the living heart of our faith, where sacred
            chants echo through the mandap, marigold garlands adorn the Lord of Obstacles, and every
            family comes together as one.&rdquo;
          </p>

          <p>
            From the auspicious morning <strong className="text-gold-300">Prana Pratishtha</strong>{' '}
            and sacred <strong className="text-gold-300">Ashtottara Shatanamavali</strong>{' '}
            recitations to the fragrant <strong className="text-gold-300">Modaka Nivedana</strong>{' '}
            and brass deepam evening <strong className="text-gold-300">Aartis</strong>, this
            sanctuary preserves the divine atmosphere, sacred rituals, and precious memories of our
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-10 sm:mt-12 pt-8 sm:pt-10 border-t border-charcoal-800 text-left">
          <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-none border-l-2 border-gold-500/60 bg-charcoal-900/80 shadow-md">
            <span className="block font-editorial text-base sm:text-lg text-gold-400 font-semibold mb-1">
              పవిత్ర పూజ
            </span>
            <span className="block text-[11px] sm:text-xs uppercase tracking-wider text-ivory-200 font-semibold mb-1">
              Sacred Pooja
            </span>
            <span className="text-[10px] sm:text-[11px] text-ivory-400 leading-snug block">
              Vedic chants & morning floral offerings.
            </span>
          </div>
          ...
          <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-none border-l-2 border-gold-500/60 bg-charcoal-900/80 shadow-md">
            ...
            <span className="text-[10px] sm:text-[11px] text-ivory-400 leading-snug block">
              Blessed Anna Prasadam &amp; community meal offerings.
            </span>
          </div>
          ...
          <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-none border-l-2 border-gold-500/60 bg-charcoal-900/80 shadow-md">
            ...
            <span className="text-[10px] sm:text-[11px] text-ivory-400 leading-snug block">
              Evening bhajans & village cultural programs.
            </span>
          </div>
          ...
          <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-none border-l-2 border-gold-400 bg-charcoal-900/80 shadow-md">
            ...
            <span className="text-[10px] sm:text-[11px] text-ivory-400 leading-snug block">
              Solemn Lake Nimajjanam farewell procession.
            </span>
          </div>
        </div>
        ...
        <div className="mt-10 flex items-center justify-center space-x-2 text-xs uppercase tracking-[0.2em] text-gold-400 font-semibold">
          <span>
            &bull; Preserving {associationName} ({villageName}) Sacred Heritage &bull;
          </span>
        </div>
      </div>
    </section>
